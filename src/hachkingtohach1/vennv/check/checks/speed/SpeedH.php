...
class SpeedH extends PacketCheck{
    ...
    public function handle(VPacket $packet, string $origin) : void{     
        ...
        if($deltaX != 0 && $lastDeltaX != 0 && $onGround && $onWeb && !$onLiquid && $location->isOnGround() && $lastLocation->isOnGround() && $lastLastLocation->isOnGround()){
            if($teleportTicks > 2){
                $limit = $speed * 19;
